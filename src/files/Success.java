...
public class Success extends JDialog {
	...
	public Success() {
		...
		setType(Type.POPUP);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Success.class.getResource("/icones/success.png")));
		setTitle("Success");
		...
		label.setIcon(new ImageIcon(Success.class.getResource("/icones/success.png")));
		label.setBounds(14, 40, 96, 96);
		contentPanel.add(label);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBorder(new LineBorder(new Color(50, 205, 50), 2));
		separator_1.setBackground(new Color(112, 128, 144));
		separator_1.setBounds(31, 24, 602, 5);
		contentPanel.add(separator_1);
		
		JSeparator separator = new JSeparator();
		separator.setBorder(new LineBorder(new Color(50, 205, 50), 2));
