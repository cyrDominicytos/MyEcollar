...
public class Warnning extends JDialog {
	...
	public Warnning() {
		...
		setType(Type.POPUP);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Warnning.class.getResource("/icones/warning.png")));
		setTitle("Attention");
		...
		label.setIcon(new ImageIcon(Warnning.class.getResource("/icones/warning.png")));
		label.setBounds(14, 40, 96, 96);
		contentPanel.add(label);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBorder(new LineBorder(new Color(255, 215, 0), 2));
		separator_1.setBackground(new Color(112, 128, 144));
		separator_1.setBounds(31, 24, 602, 5);
		contentPanel.add(separator_1);
		
		JSeparator separator = new JSeparator();
		separator.setBorder(new LineBorder(new Color(255, 215, 0), 2));
