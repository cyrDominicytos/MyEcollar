...
public class Configuration extends JPanel {
	...
	JTextPane erreur;
	Checkbox txtDebutAnnee;
	private Principal parent;
	private JTextField textField;
	private JTextField textField_1;
	public Configuration(Principal parent) {
		this.parent = parent;
		...
		JLabel lblNouvelleAnnueeScolaire = new JLabel("Configuration  de votre application");
		lblNouvelleAnnueeScolaire.setBackground(Color.WHITE);
		lblNouvelleAnnueeScolaire.setIcon(new ImageIcon(Configuration.class.getResource("/icones/newYear.png")));
		...
		panel_1.setBounds(10, 51, 488, 304);
		panel.add(panel_1);
		panel_1.setLayout(new FormLayout(new ColumnSpec[] {
				FormSpecs.RELATED_GAP_COLSPEC,
				ColumnSpec.decode("max(161dlu;default)"),
				FormSpecs.RELATED_GAP_COLSPEC,
		...
		JLabel lblClasse = new JLabel("Nom de l'ecole");
		lblClasse.setForeground(new Color(30, 144, 255));
		lblClasse.setFont(new Font("Sitka Banner", Font.BOLD, 18));
		panel_1.add(lblClasse, "2, 4, left, fill");
		
		textField_1 = new JTextField();
		panel_1.add(textField_1, "4, 4, fill, default");
		
		JLabel lblDeviseDeLecole = new JLabel("Devise de l'ecole");
		lblDeviseDeLecole.setForeground(new Color(30, 144, 255));
		lblDeviseDeLecole.setFont(new Font("Sitka Banner", Font.BOLD, 18));
		panel_1.add(lblDeviseDeLecole, "2, 6, left, default");
		
		textField = new JTextField();
		panel_1.add(textField, "3, 6, 2, 1, fill, default");
		
		JLabel lblAnneSolairee = new JLabel("Installer le syst\u00E8me de r\u00E9duction");
		lblAnneSolairee.setForeground(new Color(30, 144, 255));
		lblAnneSolairee.setFont(new Font("Sitka Banner", Font.BOLD, 18));
		panel_1.add(lblAnneSolairee, "2, 10, left, fill");
		
		txtDebutAnnee = new Checkbox();
		panel_1.add(txtDebutAnnee, "4, 10, fill, fill");
		
		Component verticalStrut_1 = Box.createVerticalStrut(20);
		panel_1.add(verticalStrut_1, "4, 12");
		
		Component verticalStrut_3 = Box.createVerticalStrut(20);
		panel_1.add(verticalStrut_3, "4, 16");
		...
		panel_1.add(lblNomDeAnne, "2, 18, left, fill");
		
		txtLibelleAnnee = new JTextField();
		txtLibelleAnnee.setEditable(false);
		panel_1.add(txtLibelleAnnee, "4, 18, 2, 1, fill, fill");
		...
		erreur.setText("Veuillez renseigner les configurations que vous souhaitez pour votre application");
		erreur.setBackground(Color.WHITE);
		erreur.setForeground(Color.BLUE);
	...
	/*public Configuration(String annee, String debut, String fin) {
		dateFin = DonneeStatiques.finAnnee;
		setBackground(Color.WHITE);
		setBorder(new LineBorder(new Color(0, 0, 0)));
		setLayout(new BorderLayout(0, 0));
		...
		txtDebutAnnee.getDateEditor().addPropertyChangeListener(new PropertyChangeListener() {
					...
					public void propertyChange(PropertyChangeEvent arg0) {
						if(verifierDate())
							txtLibelleAnnee.setText(Configuration.this.anneeScolaire());
						else
