...
public class Sorry extends JDialog {
	...
	public Sorry() {
		...
		setType(Type.POPUP);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Sorry.class.getResource("/icones/error.png")));
		setTitle("Sorry");
		...
		label.setIcon(new ImageIcon(Sorry.class.getResource("/icones/error.png")));
